defmodule TimedWeb.CoreComponents do
  @moduledoc """
  ...
  attr :wrapper_class, :string, default: nil, doc: "the class to apply to the wrapping div"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TimedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TimedWeb.Gettext, "errors", msg, opts)
    end
  end
