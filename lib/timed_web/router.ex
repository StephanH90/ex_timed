defmodule TimedWeb.Router do
  ...
  scope "/", TimedWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {TimedWeb.LiveUserAuth, :live_user_required}
      #
  ...
  scope "/", TimedWeb do
    ...
    auth_routes AuthController, Timed.Accounts.User, path: "/auth"
  ...
  # scope "/api", TimedWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:timed, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TimedWeb.Telemetry
